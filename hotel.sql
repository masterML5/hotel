...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2019 at 08:19 AM
...
CREATE TABLE IF NOT EXISTS `contact` (
  ...
  `fullname` varchar(100) COLLATE latin1_bin DEFAULT NULL,
  `phoneno` int(10) DEFAULT NULL,
  `email` text COLLATE latin1_bin NOT NULL,
  `cdate` date DEFAULT NULL,
  `approval` varchar(12) COLLATE latin1_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
...
(0, '', 'milos', 'jelic', 'Superior Room', 'Double', 1, '2019-06-07', '2019-06-14', 2240.00, 2284.80, 0.00, 'Room only', 44.80, 7),
(0, '', 'aleksa', 'ivanovic', 'Superior Room', 'Single', 1, '2019-06-08', '2019-06-10', 640.00, 659.20, 12.80, 'Breakfast', 6.40, 2);
...
(0, NULL, 'milos', 'jelic', 'milosjelic98@gmail.com', 'Serbian', 'Serbia', '0614189611', 'Superior Room', 'Single', '1', 'Breakfast', '2019-06-07', '2019-06-14', 'Not Conform', 7);
