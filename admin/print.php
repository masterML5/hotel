...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>HOTEL PATRIA,</p>
				<p>Đure Đakovića 1A,<br>Subotica,<br>Srbija.</p>
				<p>+381 (0) 24 554 500 </p>
			</address>
			<span><img alt="" src="assets/img/patria.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- 	info@hotelpatria.rs || Web :- www.hotelpatria.com || Phone :- +381 (0) 24 554 500 </p>
			</div>
		</aside>
	</body>
</html>
